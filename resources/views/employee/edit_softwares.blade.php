<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Software Details') }}
        </h2>
    </x-slot>

    <form method="POST" action="{{ route('employee.softwares.update', $software) }}"
        ...
        <div class="mb-5 mx-5">
            ...
            <select name="company_id" id="company_id"
                ...
                @foreach($companies as $company)
                    <option value="{{ $company->id }}" {{ old('company_id', $software->company_id) == $company->id ? 'selected' : '' }}>
                        {{ $company->name }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mb-5 mx-5">
            ...
            <input type="date" name="installed_date" id="installed_date"
                   value="{{ old('installed_date', $software->installed_date) }}"
                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
                   required>
        ...
        <div class="mb-5 mx-5">
            ...
            <input type="date" name="expiration_date" id="expiration_date"
                   value="{{ old('expiration_date', $software->expiration_date) }}"
                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
                   required>
        ...
        <div class="mb-5 mx-5">
            ...
            <input type="text" name="license_key" id="license_key"
                   value="{{ old('license_key', $software->license_key) }}"
                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
                   required>
        ...
        <div class="mb-5 mx-5">
            ...
            <textarea 
                ...
                rows="6"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
            >{{ old('description', $software->description) }}</textarea>
