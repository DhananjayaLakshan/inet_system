<x-app-layout>
    ...
    <form method="POST" action="{{ route('employee.visits.update', $visit) }}"
        ...
        <div class="mb-5">
            ...
            <select name="company_id" id="company_id"
                ...
                @foreach($companies as $company)
                    <option value="{{ $company->id }}" {{ old('company_id', $visit->company_id) == $company->id ? 'selected' : '' }}>
                        {{ $company->name }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mb-5">
            ...
            <input type="date" name="visit_date" id="visit_date" value="{{ old('visit_date', $visit->visit_date) }}"
                class="w-full border rounded px-3 py-2 focus:ring focus:ring-orange-200">
        ...
        <div class="mb-5">
            ...
            <input type="time" name="visit_time" id="visit_time" value="{{ old('visit_time', $visit->visit_time) }}"
                class="w-full border rounded px-3 py-2 focus:ring focus:ring-orange-200">
        ...
        <div class="mb-5">
            ...
            <input type="time" name="leave_time" id="leave_time" value="{{ old('leave_time', $visit->leave_time) }}"
                class="w-full border rounded px-3 py-2 focus:ring focus:ring-orange-200">
        ...
        <div class="mb-5">
            ...
            <textarea name="work_done" id="work_done" rows="4"
                class="w-full border rounded px-3 py-2 focus:ring focus:ring-orange-200">{{ old('work_done', $visit->work_done) }}</textarea>
